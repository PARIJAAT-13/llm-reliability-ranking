...
from llm_reliability.benchmarks.adapters.hellaswag_adapter import \
    HellaSwagAdapter
from llm_reliability.benchmarks.adapters.hotpotqa_adapter import \
    HotpotQAAdapter
from llm_reliability.benchmarks.adapters.humaneval_adapter import \
    HumanEvalAdapter
...
from llm_reliability.benchmarks.adapters.openbookqa_adapter import \
    OpenBookQAAdapter
...
from llm_reliability.benchmarks.adapters.triviaqa_adapter import \
    TriviaQAAdapter
from llm_reliability.benchmarks.adapters.truthfulqa_adapter import \
    TruthfulQAAdapter
from llm_reliability.benchmarks.adapters.webarena_adapter import \
    WebArenaAdapter
from llm_reliability.benchmarks.adapters.winogrande_adapter import \
    WinograndeAdapter
